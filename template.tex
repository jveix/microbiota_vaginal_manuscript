...
\cite{@morrillGardnerellaVaginalisCause2020; @bagnallBacterialVaginosisPractical2017}. Recently, ATCC Genome Portal has reclassified \textit{Gardnerella vaginalis} as part of \textit{Bifidobacterium} \cite{@ReclassificationBifidobacteriumGardnerella}. In two previous works, studying women with bacterial vaginosis exposed to metronidazole or clindamycin they observed mixed effects in \textit{Gardnerella} after the treatment, increasing in some women and decreasing in other \cite{@zwittinkVaginalMicrobiotaCourse2021; @ahrensChangesVaginalMicrobiota2020}. Moreover, we found \textit{Sneathia} in cases who took antibiotics. A previous work showed Sneathia was unchaged by antibiotic intake \cite{@zwittinkVaginalMicrobiotaCourse2021}.

Additionally, we identified \textit{Lactobacillus} with ALDEx2 and LEFSE as characteristic of healthy women when contrasting to RVVC. This is consistent with other works \cite{@pramanickVaginalDysbioticMicrobiome2021; @cheeVaginalMicrobiotaPotential2020} which have linked \textit{Lactobacillus} to healthy vagina when studying bacterial vaginosis.

Curiously, we found different ASVs classified as \textit{Escherichia} in our study, characterizing both cases and controls. Another report has found \textit{Escherichia} as predominant in patients with aerobic vaginitis \cite{@prasadPrevalenceEtiologyAssociated2021}.

Particularly, other bacteria identified by LEFSE analysis and associated to healthy women were \textit{Prevotella}, \textit{Limosilactobacillus}, \textit{Streptococcus} and \textit{Dialister}. The association between Bacterial Vaginosis and increased abundance of anaerobes like \textit{Prevotella}, which is an important source of lipopolysaccharide and ammonia in vaginal mocus which enhance the growth of other Bacterial Vaginosis-associated organisms like Gardnerella vagialis \cite{@randisGardnerellaPrevotellaCoconspirators2019}. \textit{Limosilactobacillus} is one of the ex-lactobacillus species, is a probiotic bacterium it can be found in various parts of the human body like Gastrointestinal tract (GI), urinary tract, skin and breast milk, and suggests its metabolites promote human health \cite{@abuqwiderLimosilactobacillusReuteriHealth2022}. In the case of \textit{Streptococcus}, has been associated to Bacterial Vaginosis in pregnant women which also present a dysbiosis of \textit{Lactobacillus} genera \cite{@ChangesVaginalMicrobiome}. The genus \textit{Dialister} also has been associated in higher prevalence and abundance in Bacterial vaginosis \cite{@liuPenileMicrobiotaFemale2015}. 
